...
public class MyPicture3 {
    ...
    public MyPicture3(float[] squareCoords, float[] color){
        // 데이터를 보내줄 때 데이터 타입을 모를 수 있으므로 String으로 보내기 위한 Buffer를 만듦

        switch (squareCoords.length/3){
            case 3: drawOrder = new short[]{0,1,2};
            case 4: drawOrder = new short[]{0,1,2, 1,2,3};
        }
