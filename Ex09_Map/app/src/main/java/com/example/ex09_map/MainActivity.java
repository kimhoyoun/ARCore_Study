...
//        좌표 : 위도 : 37.2107163000001, 경도 : 126.81822739999934       우리집
//        좌표 : 위도 : 37.476574499999614, 경도 : 126.9729838999998      사당역
//        좌표 : 위도 : 37.497951699999575, 경도 : 127.01923959999992     강남역
        mPlaces.add(new MyPlace("우리집", 37.2107163000001,126.81822739999934, Color.RED));
        mPlaces.add(new MyPlace("강남역", 37.497951699999575, 127.01923959999992, Color.BLUE));
        mPlaces.add(new MyPlace("사당역", 37.476574499999614, 126.9729838999998, Color.GREEN));
    ...
    // ARCore의 현재위치 -- 실상 화면에 보이지 않아도 무방하다.
    //화면 가운데 내위치 보여주기
...
//                super.onLocationResult(locationResult);
        ...
        // 요청객체로 갱신
        fusedLocationProviderClient.requestLocationUpdates(locRequest, locCallback, Looper.myLooper());
    }
